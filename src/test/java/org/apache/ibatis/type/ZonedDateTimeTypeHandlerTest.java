...
public class ZonedDateTimeTypeHandlerTest extends BaseTypeHandlerTest {
  ...
  public void shouldGetResultFromResultSetByName() throws Exception {
    ...
    assertThat(TYPE_HANDLER.getResult(rs, "column")).isEqualTo(ZONED_DATE_TIME);
  }
  ...
  public void shouldGetResultFromResultSetByPosition() throws Exception {
    ...
    assertThat(TYPE_HANDLER.getResult(rs, 1)).isEqualTo(ZONED_DATE_TIME);
  }
  ...
  public void shouldGetResultFromCallableStatement() throws Exception {
    ...
    assertThat(TYPE_HANDLER.getResult(cs, 1)).isEqualTo(ZONED_DATE_TIME);
  }
